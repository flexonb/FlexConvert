...
```bash
git remote add encore encore://flexconvert-app-p5ti
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/flexconvert-app-p5ti/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/flexconvert-app-p5ti/settings/integrations/github)
