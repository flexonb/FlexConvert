...
import { trackUsage as api_analytics_track_usage_trackUsage } from "~backend/analytics/track_usage";
...
export namespace analytics {
    ...
    export class ServiceClient {
        ...
        public async getStats(params: RequestType<typeof api_analytics_get_stats_getStats>): Promise<ResponseType<typeof api_analytics_get_stats_getStats>> {
            ...
            const resp = await this.baseClient.callTypedAPI(`/analytics/stats`, {query, method: "GET", body: undefined})
         ...
         */
        public async trackUsage(params: RequestType<typeof api_analytics_track_usage_trackUsage>): Promise<void> {
            await this.baseClient.callTypedAPI(`/analytics/track`, {method: "POST", body: JSON.stringify(params)})
        }
    }
}
