    ...
    export default function ImageOperationDialog({
      ...
      if (operation === 'crop') {
        const handleCropConfirm = () => {
          ...
          onConfirm({ ...options, area: croppedAreaPixels });
        };
          ...
          <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>Adjust the crop area. The same crop will be applied to all selected images.</DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <OutputFormatQuality 
                    format={(options as CropOptions).format ?? "jpeg"} 
                    quality={(options as CropOptions).quality ?? 0.92} 
                    onChange={(format, quality) => setOptions({ ...options, format, quality })}
                  />
                </div>
              </div>
              <DialogFooter>
